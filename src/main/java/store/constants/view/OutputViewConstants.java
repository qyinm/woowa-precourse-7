...
public enum OutputViewConstants {
    ...
    ASK_GET_MORE_BONUS_PRODUCTS("현재 %s은(는) %d개를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)"),
    ...
    private final String outputViewPrefix;

    OutputViewConstants(String outputViewPrefix) {
        this.outputViewPrefix = outputViewPrefix;
    }

    public String getOutputViewPrefix() {
        return outputViewPrefix;
    }
}
